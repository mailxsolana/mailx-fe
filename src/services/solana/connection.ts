...
export const SOLANA_CONNECTION = new Connection("https://api.devnet.solana.com", { commitment: 'confirmed', httpHeaders: { "x-session-hash": SESSION_HASH } });
export const SOLANA_CONNECTION_FINALIZED = new Connection("https://api.devnet.solana.com", { commitment: 'finalized', httpHeaders: { "x-session-hash": SESSION_HASH } });
export const SOLANA_CONNECTION_BUNDLR = new Connection("https://api.devnet.solana.com", { commitment: 'finalized', httpHeaders: { "x-session-hash": SESSION_HASH } });
